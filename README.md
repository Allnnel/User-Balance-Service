...
- - `src/main/java/com/example/controller`: Здесь содержатся классы контроллеров, которые обрабатывают HTTP-запросы от клиентов.
- `src/main/java/com/example/response`: Здесь находятся классы, представляющие модели данных, такие как пользователи и балансы.
- `src/main/java/com/example/repository`: Этот пакет представляет шаблоны ответа для взаимодействия с клиентами. 
